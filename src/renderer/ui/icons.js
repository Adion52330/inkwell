...
export const icons = {
  ...
  selectText:
    '<path d="M9 5.2h1.6A1.4 1.4 0 0 1 12 6.6a1.4 1.4 0 0 1 1.4-1.4H15"/><path d="M12 6.6v10.8"/><path d="M9 18.8h1.6A1.4 1.4 0 0 0 12 17.4a1.4 1.4 0 0 0 1.4 1.4H15"/><path d="M4.5 8.6V6.2a1.7 1.7 0 0 1 1.7-1.7h2.2M19.5 8.6V6.2a1.7 1.7 0 0 0-1.7-1.7h-2.2M4.5 15.4v2.4a1.7 1.7 0 0 0 1.7 1.7h2.2M19.5 15.4v2.4a1.7 1.7 0 0 1-1.7 1.7h-2.2"/>',
